document.addEventListener('DOMContentLoaded', function () {
    // Bind click event outside of any function
    document.getElementById('accessory-merch').addEventListener('click', function () {
        // Make AJAX request to fetch music products
        $.ajax({
            type: "GET",
            url: 'https://nyxsolutions.co.ke/rage.machine/fetch-accessories.php',
            dataType: 'json',
